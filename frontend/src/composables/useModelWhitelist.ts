...
const openaiPresetMappings = [
  ...
  { label: 'Sol→Sol-WM', from: 'gpt-5.6-sol', to: 'gpt-5.6-sol-wm', color: 'bg-emerald-100 text-emerald-700 hover:bg-emerald-200 dark:bg-emerald-900/30 dark:text-emerald-400' },
  ...
  { label: 'Terra→Terra-WM', from: 'gpt-5.6-terra', to: 'gpt-5.6-terra-wm', color: 'bg-emerald-100 text-emerald-700 hover:bg-emerald-200 dark:bg-emerald-900/30 dark:text-emerald-400' },
  ...
  { label: 'Luna→Luna-WM', from: 'gpt-5.6-luna', to: 'gpt-5.6-luna-wm', color: 'bg-emerald-100 text-emerald-700 hover:bg-emerald-200 dark:bg-emerald-900/30 dark:text-emerald-400' },
